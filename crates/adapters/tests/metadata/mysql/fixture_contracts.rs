...
fn mysql_fixtures_use_sql_valid_invalid_layout() {
    for required_path in [
        ...
        "fixtures/sql/valid/mutation_builders.sql",
        ...
        "fixtures/sql/invalid/top_level_repeat.sql",
        "fixtures/sql/invalid/top_level_repeat_end.sql",
        "fixtures/sql/invalid/repeat_missing_end.sql",
        "fixtures/sql/invalid/repeat_end_without_start.sql",
        "fixtures/sql/invalid/repeat_nested_ranges.sql",
        "fixtures/sql/invalid/repeat_inside_param_range.sql",
        "fixtures/sql/invalid/slot_inside_repeat_range.sql",
        "fixtures/sql/invalid/repeat_without_param.sql",
        "fixtures/sql/invalid/repeat_invalid_id.sql",
        "fixtures/sql/invalid/repeat_missing_separator.sql",
        "fixtures/sql/invalid/repeat_non_string_separator.sql",
        "fixtures/sql/invalid/repeat_unknown_metadata_field.sql",
        "fixtures/sql/invalid/repeat_end_unknown_metadata_field.sql",
        "fixtures/sql/invalid/direct_param_repeat_id_collision.sql",
        "fixtures/sql/invalid/slot_repeat_id_collision.sql",
        "fixtures/sql/invalid/fragment_param_repeat_branch_collision.sql",
        "fixtures/sql/invalid/repeated_repeat_item_shape_conflict.sql",
        "fixtures/sql/invalid/repeated_repeat_item_type_conflict.sql",
        "fixtures/sql/invalid/repeated_repeat_item_nullability_conflict.sql",
        "fixtures/sql/invalid/repeat_representative_invalid_sql.sql",
        "fixtures/sql/invalid/repeat_validation_case_limit_exceeded.sql",
        "fixtures/sql/invalid/repeat_param_inference_failure.sql",
        "fixtures/sql/invalid/repeated_repeat_item_inferred_type_conflict.sql",
        "fixtures/sql/invalid/mutation_multi_table_update.sql",
        "fixtures/sql/invalid/mutation_multi_table_delete.sql",
        "fixtures/sql/invalid/mutation_insert_select.sql",
        "fixtures/sql/invalid/mutation_replace_select.sql",
        "fixtures/sql/invalid/mutation_cte.sql",
        "fixtures/sql/invalid/mutation_call.sql",
        "fixtures/sql/invalid/mutation_load_data.sql",
        "fixtures/sql/invalid/mutation_truncate.sql",
        "fixtures/sql/invalid/mutation_ddl.sql",
        "fixtures/sql/invalid/mutation_multiple_statements.sql",
        "fixtures/sql/invalid/mutation_update_without_where.sql",
        "fixtures/sql/invalid/mutation_delete_without_where.sql",
        "fixtures/sql/invalid/mutation_raw_placeholder.sql",
        "fixtures/sql/invalid/mutation_unsupported_inference_context.sql",
    ] {
        assert!(
